...
│
├── testing/                                # 测试文档
│   └── 测试指南.md                          # 完整测试指南 (快速+详细+Bug修复验证)
│
├── development/                            # 开发文档
│   ├── AGENTS.md                           # AI 辅助开发指南
│   ├── WORK_LOG.md                         # 项目开发日志
│   ├── 工作总结.md                          # 最新会话工作总结 (包含 2026-01-27 Bug修复)
...
3. 然后：`development/工作总结.md` - 了解最新功能与修复
4. 最后：根据要开发的模块查阅相应技术文档

### 我要测试功能
- **完整指南**：`testing/测试指南.md`（包含快速验证与详细清单）

### 我要了解项目历史
- **开发日志**：`development/WORK_LOG.md`
- **最新进展**：`development/工作总结.md`（最后更新: 2026-01-27）
